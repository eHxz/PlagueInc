...
// ---------- 5) ISO-3166-1 alpha-2（小写）-> 地区 映射 ----------
// 新版世界地图（BlankMap-World-Equirectangular.svg）以 class="land xx" 中的两位
// 国家代码标识国家，故按代码归区。内容与上方 overrides() 完全对应。
inline const QHash<QString, int> &isoOverrides()
{
    static const QHash<QString, int> kIso = {
        {"us", 0}, {"pr", 0}, {"vi", 0}, {"um", 0},
        {"ca", 1}, {"pm", 1},
        {"mx", 2},
        {"bz", 3}, {"cr", 3}, {"sv", 3}, {"gt", 3}, {"hn", 3}, {"ni", 3}, {"pa", 3},
        {"ai", 4}, {"ag", 4}, {"aw", 4}, {"bs", 4}, {"bb", 4}, {"bm", 4}, {"bq", 4},
        {"vg", 4}, {"ky", 4}, {"cu", 4}, {"cw", 4}, {"dm", 4}, {"do", 4}, {"gd", 4},
        {"gp", 4}, {"ht", 4}, {"jm", 4}, {"mq", 4}, {"ms", 4}, {"bl", 4}, {"kn", 4},
        {"lc", 4}, {"mf", 4}, {"vc", 4}, {"sx", 4}, {"tt", 4}, {"tc", 4}, {"an", 4},
        {"gl", 5},
        {"br", 6},
        {"ar", 7}, {"cl", 7}, {"fk", 7}, {"uy", 7},
        {"ec", 8}, {"pe", 8},
        {"co", 9}, {"gf", 9}, {"gy", 9}, {"sr", 9}, {"ve", 9},
        {"bo", 10}, {"py", 10},
        {"gg", 11}, {"ie", 11}, {"im", 11}, {"je", 11}, {"gb", 11},
        {"fo", 12}, {"is", 12},
        {"bv", 13}, {"no", 13}, {"sj", 13},
        {"se", 14},
        {"ax", 15}, {"fi", 15},
        {"ad", 16}, {"fr", 16}, {"fx", 16}, {"mc", 16}, // fx=法国本土
        {"gi", 17}, {"pt", 17}, {"es", 17},
        {"it", 18}, {"mt", 18}, {"sm", 18}, {"va", 18},
        {"be", 19}, {"dk", 19}, {"de", 19}, {"lu", 19}, {"nl", 19},
        {"pl", 20},
        {"ru", 21},
        {"by", 22}, {"md", 22}, {"ua", 22},
        {"tr", 23},
        {"al", 24}, {"ba", 24}, {"bg", 24}, {"hr", 24}, {"cy", 24}, {"gr", 24},
        {"xk", 24}, {"me", 24}, {"mk", 24}, {"ro", 24}, {"rs", 24}, {"si", 24},
        {"ee", 25}, {"lv", 25}, {"lt", 25},
        {"at", 26}, {"cz", 26}, {"hu", 26}, {"li", 26}, {"sk", 26}, {"ch", 26},
        {"eg", 27},
        {"ly", 28},
        {"dz", 29}, {"tn", 29},
        {"ma", 30}, {"eh", 30},
        ...
        {"ao", 32},
        {"bw", 33},
        {"mw", 34}, {"mz", 34}, {"zm", 34}, {"zw", 34},
        {"km", 35}, {"mg", 35}, {"mu", 35}, {"yt", 35}, {"re", 35}, {"sc", 35},
        {"sz", 36}, {"ls", 36}, {"na", 36}, {"za", 36},
        {"cm", 37}, {"cf", 37}, {"td", 37}, {"cd", 37}, {"gq", 37}, {"ga", 37}, {"cg", 37},
        {"bi", 38}, {"dj", 38}, {"er", 38}, {"et", 38}, {"ke", 38}, {"rw", 38},
        {"so", 38}, {"tz", 38}, {"ug", 38},
        {"bj", 39}, {"bf", 39}, {"cv", 39}, {"ci", 39}, {"gm", 39}, {"gh", 39},
        {"gn", 39}, {"gw", 39}, {"lr", 39}, {"ml", 39}, {"mr", 39}, {"ne", 39},
        {"ng", 39}, {"st", 39}, {"sn", 39}, {"sl", 39}, {"tg", 39},
        {"sa", 40},
        {"ir", 41},
        {"iq", 42},
        {"bh", 43}, {"il", 43}, {"jo", 43}, {"kw", 43}, {"lb", 43}, {"om", 43},
        {"ps", 43}, {"qa", 43}, {"sy", 43}, {"ae", 43}, {"ye", 43},
        {"af", 44},
        {"kz", 45},
        {"am", 46}, {"az", 46}, {"ge", 46}, {"kg", 46}, {"tj", 46}, {"tm", 46}, {"uz", 46},
        {"cn", 47}, {"mn", 47}, {"tw", 47}, // tw=台湾，并入中国
        {"bd", 48}, {"bt", 48}, {"io", 48}, {"in", 48}, {"mv", 48}, {"np", 48}, {"lk", 48},
        {"pk", 49},
        {"jp", 50},
        {"kp", 51}, {"kr", 51},
        {"id", 52}, {"tl", 52},
        {"ph", 53},
        {"bn", 54}, {"kh", 54}, {"la", 54}, {"my", 54}, {"mm", 54}, {"sg", 54},
        {"th", 54}, {"vn", 54},
        {"au", 55}, {"cx", 55}, {"cc", 55}, {"hm", 55},
        {"as", 56}, {"ck", 56}, {"fm", 56}, {"pf", 56}, {"gu", 56}, {"ki", 56},
        {"mh", 56}, {"nr", 56}, {"nz", 56}, {"nu", 56}, {"nf", 56}, {"mp", 56},
        {"pw", 56}, {"pn", 56}, {"ws", 56}, {"tk", 56}, {"to", 56}, {"tv", 56}, {"wf", 56},
        {"fj", 57}, {"nc", 57}, {"pg", 57}, {"sb", 57}, {"vu", 57}
    };
    return kIso;
}

// ISO 两位代码 -> 地区下标；未列入返回 -1（中立陆地）
inline int regionForIso(const QString &iso)
{
    const auto &ov = isoOverrides();
    auto it = ov.find(iso.toLower());
    return (it != ov.end()) ? it.value() : -1;
}
